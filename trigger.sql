...
/* TRIGGER QUI VA FAIRE APPELLE A UNE FONCTION AFIN DE METRE A JOUR LA QUANTITE DU PRODUIT APRESV VENTE*/

CREATE OR REPLACE TRIGGER tr_majQuantite_Sell
...
BEGIN
    majSellQuantite(NEW.ID_PRODUIT).
END;
/
SHOW ERRORS
...
/* TRIGGER QUI VA FAIRE APPELLE A UNE FONCTION AFIN DE METRE A JOUR LA QUANTITE DU PRODUIT APRES EST_COMMANDE*/

CREATE OR REPLACE TRIGGER tr_majQuantite_Commande
AFTER INSERT ON EST_COMMANDE
FOR EACH ROW

DECLARE;

BEGIN
    majAddQuantite(NEW.ID_PRODUIT,NEW.QUANTITE).
END;
/
